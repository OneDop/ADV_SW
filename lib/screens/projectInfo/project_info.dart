    ...
    return Column(children: [
      Padding(
        ...
        child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          ...
          _AddBtn(onTap: () => _showCreateTaskSheet(context)),
        ]),
      ),
      Expanded(
                ...
                onLongPress: isMe ? () async {
                  final confirm = await showDialog<bool>(
                    ...
                    builder: (_) => AlertDialog(
                      ...
                      content: const Text('This will permanently remove your message.'),
                      actions: [
                  ...
                  if (confirm == true) {
                    ref.read(chatProvider(widget.projectId).notifier).deleteMessage(msg.id);
                  }
                } : null,
                child: _Bubble(text: msg.content, time: DateFormat('HH:mm').format(msg.sentAt), isMe: isMe, senderName: msg.senderName),
              );
            },
          ),
          loading: () => const Center(child: CircularProgressIndicator()),
